...
1. Find the string `default-value-enter-your-client-credential-here` and replace the existing value with the key you saved during the creation of the `python-flask-webapp-call-graph` app, in the Azure portal.
