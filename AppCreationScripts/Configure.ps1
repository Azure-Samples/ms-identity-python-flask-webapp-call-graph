...
#> 
   ...
   Write-Host "Creating the AAD application (python-flask-webapp-call-graph)"
   ...
   $webAppAadApplication = New-AzureADApplication -DisplayName "python-flask-webapp-call-graph" `
                                                  -HomePage "https://127.0.0.1:5000" `
                                                  -ReplyUrls "https://127.0.0.1:5000/auth/redirect" `
                                                  -IdentifierUris "https://$tenantName/python-flask-webapp-call-graph" `
   ...
   Write-Host "Done creating the webApp application (python-flask-webapp-call-graph)"
   ...
   Add-Content -Value "<tr><td>webApp</td><td>$currentAppId</td><td><a href='$webAppPortalUrl'>python-flask-webapp-call-graph</a></td></tr>" -Path createdApps.html
